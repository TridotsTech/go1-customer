                ...
                <div class="hai border rounded">
                    ...
                    <div class="main flex flex-row gap-6 pt-2">
                        <div class="w-1/2 p-2 min-h-70">
                            ...
                            <div class="flex items-center gap-2 px-3 leading-5 first:mt-3 text-center mt-3 pb-1">
                                <div class="sm:w-36 shrink-0 text-sm text-gray-600 text-left">Delivery Date:</div>
                                <div class="grid min-h-[18px] flex-1 items-center overflow-hidden text-base text-center">{{ DeliveryDate }}</div>
                            </div>
                        </div>
...
const fetchQuotation = async () => {
    try {
        ...
        if (details) {
            ...
            DeliveryDate.value = details.delivery_date
